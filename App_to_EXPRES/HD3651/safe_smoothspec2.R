library(parallel)
filenames = list.files(path = "3651spec", pattern = "*_2.csv")
options(digits=10)
srtid = as.numeric(gsub("ctd_2.csv", "", gsub("3651_", "", filenames)))
...
write.csv(smoothtemp, file = "3651smoothtemp2.csv", row.names=FALSE)
