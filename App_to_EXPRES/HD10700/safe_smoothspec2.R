library(parallel)
filenames = list.files(path = "10700spec", pattern = "*_2.csv")
options(digits=10)
srtid = as.numeric(gsub("ctd_2.csv", "", gsub("10700_", "", filenames)))
...
write.csv(smoothtemp, file = "10700smoothtemp2.csv", row.names=FALSE)
