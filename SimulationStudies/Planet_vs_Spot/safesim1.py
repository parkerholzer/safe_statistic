...
#READ IN SPECTRA
filenames = [f for f in glob.glob("spot_1pcnt/*00.csv")]
phs = []
for f in filenames:
...
template = read_csv("spot_1pcnt/integrated_spectrum_full_reso_spot_prot_25.0_size_0.010_lat_0_phase_-0.5000.csv")
...
Features = read_csv("SOAP_Features.csv")
